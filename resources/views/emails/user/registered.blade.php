...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <a href="https://www.primesglobe.com" target="_blank" >
        ...
        <div style="padding:25px 0px 25px 0px">
         ...
         <br><br>
            ...
            <!-- <a href="https://www.primesglobe.com/platforms" style="color:#f00" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://www.primesglobe.com/platforms&amp;source=gmail&amp;ust=1629257826760000&amp;usg=AFQjCNGICyUGuPZdfvIbYoHen-evQqlPYw">
                trading platforms
            </a>  -->
        ...
        <a href="https://primesglobe.com/user/account/verification?token={{  $details['token'] }}&email={{ $details['email'] }}" style="color:#ffffff;text-decoration:none" target="_blank">
            <div align="center" style="width:400px;background-color:#d50002;border-radius:5px;text-align:center;padding:10px 20px;color:#ffffff;font-size:16px;font-weight:bold;margin:auto">
