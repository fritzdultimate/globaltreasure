...
@section('content')
    <div class="Content" data-v-23e9d8b4="">
        <div class="banner" data-v-23e9d8b4="">
            <div class="wrap" data-v-23e9d8b4="">
                <div class="banner-con" data-v-23e9d8b4="">
                    <div class="dl" data-v-23e9d8b4="">
                        <h2 class="pub_banner_tit" data-v-23e9d8b4="">
                    ...
                    <div class="dr" data-v-23e9d8b4="">
                        <img src="{{ asset('guest/img/bg1.40e82ed.jpg') }}" width="344" alt="" data-v-23e9d8b4="" />
                    </div>
                </div>
            </div>
        </div>
        <div class="con-text" data-v-23e9d8b4="">
            <div class="wrap" data-v-23e9d8b4="">
                ...
                <p class="jt_sty" data-v-23e9d8b4="">Maintain a 1:1 ratio of company cash flow to client funds.</p>
                <p class="jt_sty" data-v-23e9d8b4="">Client transaction settlement funds are deposited separately and conduct daily reconcile.</p>
            </div>
        </div>
        <div class="reasons__account padding_100" data-v-cd66b8a2="" data-v-23e9d8b4="">
            <div class="wrap" data-v-cd66b8a2="">
                ...
                <div class="reason_item_list" data-v-cd66b8a2="">
                    ...
                    <div class="reason_item" data-v-cd66b8a2="">
                        <div data-v-cd66b8a2=""><i class="iconfont iconquotes" data-v-cd66b8a2=""></i></div>
                        <p data-v-cd66b8a2="">Unlimited virtual funds for demo account</p>
                    </div>
                    <div class="reason_item" data-v-cd66b8a2="">
                    ...
                    <div class="reason_item" data-v-cd66b8a2="">
                        ...
                        <p data-v-cd66b8a2="">Real time Quotation Notification</p>
                    </div>
                    <div class="reason_item" data-v-cd66b8a2="">
        ...
        <div class="open-account white" data-v-b35408fa="" data-v-23e9d8b4="">
            <p data-v-b35408fa="">
                <a href="../depositsBonus.html" class="underline_a" data-v-b35408fa=""><span data-v-b35408fa="">Get up to $4000 withdrawable trading bonus</span></a>
            </p>
            <a class="btn_sty btn_sx" data-v-b35408fa="">Start Trading Now</a>
            <p class="p1" data-v-b35408fa="">
                or
                <a class="btn-p-bot underline_a" data-v-b35408fa="">Try Free Demo Account</a>
            </p>
        </div>
    </div>
@endsection
@push('top')
    <link rel="stylesheet" href="{{ asset('guest/css/clients-fund.css') }}" />
@endpush