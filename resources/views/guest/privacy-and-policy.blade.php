...
@section('title', 'PrimesGlobe | Privacy Policy')
...
<div class="Content" data-v-e58086ca="">
    <div class="wrap" data-v-e58086ca="">
        ...
        <div class="col-md-8 col-12" style="float:none">
            ...
            <p> PrimesGlobe (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by PrimesGlobe.</p>
            <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, PrimesGlobe. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service. </p>
            ...
            <li class="py-1"><b>Company:</b> when this policy mentions “Company,” “we,” “us,” or “our,” it refers to PrimesGlobe that is responsible for your information under this Privacy Policy.</li>
            <li class="py-1"><b>Country:</b> where PrimesGlobe or the owners/founders of PrimesGlobe are based, in this case is USA</li>
            <li class="py-1"><b>Customer:</b>&nbsp;refers to the company, organization or person that signs up to use the PrimesGlobe Service to manage the relationships with your consumers or service users.</li>
            <li class="py-1"><b>Device:</b>&nbsp;any internet connected device such as a phone, tablet, computer or any other device that can be used to visit PrimesGlobe and use the services.</li>
            ...
            <li class="py-1"><b>Personnel:</b>&nbsp;refers to those individuals who are employed by PrimesGlobe or are under contract to perform a service on behalf of one of the parties.</li>
            ...
            <li class="py-1"><b>Service:</b> refers to the service provided by PrimesGlobe as described in the relative terms (if available) and on this platform.</li>
            ...
            <li class="py-1"><b>Website:</b> PrimesGlobe's site, which can be accessed via this URL: primesglobe.com</li>
            <li class="py-1"><b>You:</b> a person or entity that is registered with PrimesGlobe to use the Services.</li>
            </ul>
            <p></p>
            <br>
            ...
            <br>
            <h1 class="fw-bold">When does PrimesGlobe use end user information from third parties?</h1>
            <p>PrimesGlobe will collect End User Data necessary to provide the PrimesGlobe services to our customers.</p>
            ...
            <br>
            <h1 class="fw-bold">When does PrimesGlobe use customer information from third parties?</h1>
            <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a PrimesGlobe customer, we receive information from a third party that provides automated fraud detection services to PrimesGlobe. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
            ...
            <p>PrimesGlobe will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
            ...
            <p>The rights you have to request updates or corrections to the information PrimesGlobe collects depend on your relationship with PrimesGlobe. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
            ...
            <p>If you are a PrimesGlobe worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
            ...
            <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of PrimesGlobe or any of its Corporate Affiliates (as defined herein), or that portion of PrimesGlobe or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

            <br>
            <h1 class="fw-bold">Affiliates</h1>
            <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with PrimesGlobe, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
            ...
            <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by PrimesGlobe. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
            <br>
